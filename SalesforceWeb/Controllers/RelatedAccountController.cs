...
namespace SalesforceWeb.Controllers
{
    public class RelatedAccountController : Controller
    {
        ...
        public RelatedAccountController(IPractitionerService practitionerService, IMapper mapper, IOAuthService oAuthService, ISalesforceService salesforceService, ILogger<PractitionerController> logger)
        {
