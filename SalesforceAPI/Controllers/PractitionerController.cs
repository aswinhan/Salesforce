...
namespace SalesforceAPI.Controllers
{
    ...
    public class PractitionerController : ControllerBase
    {
        ...
        public PractitionerController(ApplicationDbContext context, IPractitionerRepository dbPractitioner, IMapper mapper, ProviderService providerService)
        {
            _context = context;
        ...
        public async Task<ActionResult<APIResponse>> GetPractitioner(string id)
        {
            try
            {
                if (id == null || id == "")
